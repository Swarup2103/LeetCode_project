...
function CreateProblem() {
    ...
    const onSubmit = async (data) => {
        try {
            ...
            alert("Error: " + (error.response?.data?.message || "Could not create problem."));
        }
    };
        ...
        <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
                <div className="text-center mb-8">
                    ...
                    <p className="mt-2 text-sm text-gray-600">Fill in the details below to create a new coding problem</p>
                </div>
                ...
                <form onSubmit={handleSubmit(onSubmit)} noValidate>
                    ...
                    <div className="bg-white shadow rounded-lg mb-6 overflow-hidden">
                        <div className="px-6 py-4 border-b border-gray-200">
                            ...
                            <p className="mt-1 text-sm text-gray-500">Core details about the problem</p>
                        </div>
                    ...
                    <FieldArraySection
                        ...
                        legend="Starter Code"
                        fieldsConfig={[
                            { name: 'language', label: 'Language (e.g., cpp, java, javascript)', type: 'input' },
